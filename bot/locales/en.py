...
BTN_ADMIN_GATE = "🔐 Forced join"
GATE_BTN_ADD = "➕ Add channel"
GATE_BTN_OFF = "🚫 Disable forced join"
GATE_ADD_PROMPT = (
    "🔐 <b>Add a channel</b>\n\n"
    ...
    "⚠️ The bot must be an <b>admin</b> in that channel, otherwise it cannot "
    "check membership."
)
GATE_PANEL_HINT = "Add a channel below to require users to join it."
GATE_PANEL_COUNT = "🔢 Channels: <b>{count}</b>"
GATE_PANEL_OFF = "🔓 <b>Forced join is off</b>\n\nNo channel configured — everyone can use the bot freely."
GATE_PANEL_BROKEN = "⚠️ <b>{count}</b> channel(s) not working — promote the bot to admin there."
GATE_PANEL_REMOVE_HINT = "Tap a ➖ button to remove that channel."
BTN_BACK = "🔙 Back"
BTN_CLOSE = "✖️ Close"
BTN_CONFIRM_YES = "✅ Yes"
...
BTN_PNG = "🖼 PNG file (original quality)"
PNG_WORKING = "🖼 Fetching the original image..."
PNG_READY = "🖼 <b>{width}×{height}</b> · {size}MB · lossless PNG"
PNG_FAILED = "❌ Couldn't fetch the original image. Try again later."
PNG_UNAVAILABLE = "❌ This platform has no PNG original."
PNG_TOO_BIG = "❌ The PNG came out too large ({size}MB) — Telegram allows up to 50MB."
