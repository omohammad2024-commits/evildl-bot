...
HINT_YT_COOKIE = (
    "یوتیوب از این سرور کوکی لاگین می‌خواهد. تا ادمین کوکی نصب نکند، "
    "دانلود یوتیوب کار نمی‌کند — تلاش مجدد فایده‌ای ندارد."
)
...
INBOX_UNREAD_LINE = "🔴 خوانده‌نشده: <b>{count}</b>"
INBOX_TAP_MEDIA = "فایل دارد →"
INBOX_BTN_STARRED = "⭐ نشان‌شده‌ها"
INBOX_BTN_READALL = "✅ همه خوانده شد"
INBOX_BTN_BROADCAST = "📣 پیام به همه"
INBOX_BTN_GALLERY = "🗂 فایل‌ها"
INBOX_READALL_OK = "✅ همه گفتگوها خوانده‌شده علامت خوردند"
INBOX_GALLERY_TITLE = "🗂 <b>فایل‌های {who}</b>"
INBOX_GALLERY_EMPTY = "این کاربر هنوز فایلی نفرستاده."
INBOX_GALLERY_HINT = "روی هر دکمه بزن تا همان فایل برایت فرستاده شود."
INBOX_STARRED_TITLE = "⭐ <b>پیام‌های نشان‌شده</b>"
INBOX_STARRED_EMPTY = "هنوز پیامی نشان نکرده‌ای."
INBOX_MEDIA_SENT = "📤 فرستاده شد"
INBOX_MEDIA_MISSING = "❌ این پیام پیدا نشد."
INBOX_MEDIA_NONE = "❌ این پیام فایلی ندارد."
INBOX_MEDIA_FAIL = "❌ ارسال فایل ناموفق بود: {error}"
INBOX_MEDIA_CAPTION = "از <b>{who}</b> · {when}"
INBOX_STAR_ON = "⭐ نشان شد"
INBOX_STAR_OFF = "☆ نشان برداشته شد"
INBOX_NO_HISTORY = "بدون پیام ثبت‌شده"
INBOX_COUNT = "👥 کاربران: <b>{count}</b>"

# ── live activity feed ────────────────────────────────────────────────
FEED_TITLE = "🔔 <b>فعالیت زنده</b>"
FEED_DROPPED = "<i>… و {count} رویداد دیگر (شلوغ بود)</i>"
FEED_BTN_OPEN = "📂 باز کردن گفتگو"
FEED_BTN_MUTE = "🔕 خاموش کردن"
FEED_BTN_TOGGLE_ON = "🔔 فعالیت زنده: روشن"
FEED_BTN_TOGGLE_OFF = "🔕 فعالیت زنده: خاموش"
FEED_ENABLED = "🔔 فعالیت زنده روشن شد — از این به بعد هر کاری کاربران بکنند همان لحظه برایت می‌فرستم."
FEED_DISABLED = "🔕 فعالیت زنده خاموش شد."

# ── forced-join manager (admin panel) ─────────────────────────────────
BTN_ADMIN_GATE = "🔐 جوین اجباری"
GATE_BTN_ADD = "➕ افزودن کانال"
GATE_BTN_OFF = "🚫 خاموش کردن جوین اجباری"
GATE_ADD_PROMPT = (
    "🔐 <b>افزودن کانال</b>\n\n"
    "یوزرنیم یا لینک کانال رو بفرست:\n"
    "<code>@mychannel</code>\n"
    "<code>https://t.me/mychannel</code>\n"
    "<code>-1001234567890</code>\n\n"
    "⚠️ ربات باید توی کانال <b>ادمین</b> باشه، وگرنه نمی‌تونه عضویت رو چک کنه."
)
GATE_PANEL_HINT = "با دکمهٔ زیر کانال اضافه کن تا کاربران مجبور شوند عضو شوند."
GATE_PANEL_COUNT = "🔢 تعداد کانال‌ها: <b>{count}</b>"
GATE_PANEL_OFF = "🔓 <b>جوین اجباری خاموش است</b>\n\nهیچ کانالی تنظیم نشده — همه آزادانه از ربات استفاده می‌کنند."
GATE_PANEL_BROKEN = "⚠️ <b>{count}</b> کانال کار نمی‌کند — ربات را در آن ادمین کن."
GATE_PANEL_REMOVE_HINT = "برای حذف، روی دکمهٔ ➖ کانال بزن."
BTN_BACK = "🔙 بازگشت"
BTN_CLOSE = "✖️ بستن"
BTN_CONFIRM_YES = "✅ بله"
...
BTN_PNG = "🖼 فایل PNG (کیفیت اصل)"
PNG_WORKING = "🖼 دارم اصل تصویر رو می‌گیرم..."
PNG_READY = "🖼 <b>{width}×{height}</b> · {size}MB · PNG بدون افت کیفیت"
PNG_FAILED = "❌ نشد اصل تصویر رو بگیرم. بعداً امتحان کن."
PNG_UNAVAILABLE = "❌ این پلتفرم فایل PNG ندارد."
PNG_TOO_BIG = "❌ فایل PNG خیلی بزرگ شد ({size}MB) — تلگرام تا ۵۰MB قبول می‌کند."
...
INLINE_CACHED_DESC = "⚡ آماده است — بدون انتظار ارسال می‌شود"
